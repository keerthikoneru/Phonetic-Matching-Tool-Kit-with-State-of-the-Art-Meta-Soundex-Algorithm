 ...
 *
 */
public class MatchedComparison_MetaSoundex {
	 ...
	 * @throws Exception
	 */
	public void matched_metasoundex(String savepath,
		...
		String file1 = path + "mismatched_metasoundex.csv";
		String file2 = path + "matched_metasoundex.csv";
				...
				if (al1.get(k).matches(part1)) {
					if (part2.matches(al3.get(k))
						...
						for (WordSuggestions ws : WordSuggestions) {
							if (ws.type.matches("MetaSoundex")
