 ...
 *
 */
public class MatchedComparison_nysiis {
	 ...
	 * @throws Exception
	 */
	public void matched_nysiis(String savepath,
			List<WordSuggestions> WordSuggestions)
			throws FileNotFoundException, IOException, Exception {
		/**
		 * Comparison of nysiis word list with Original list
		 */
		String path = savepath;
		String file1 = path + "mismatched_nysiis.csv";
		String file2 = path + "matched_nysiis.csv";
		...
		/**
		 * Reading Matched word list of Nysiis into Arraylist start
		 */
		...
		CSVFile2.close();
		/**
		 * Reading Matched word list of Nysiis into Arraylist end
		 */
		...
		/**
		 * Updating Manipulated data based on Matched list of Nysiis start
		 */
		...
		writer.close();
		/**
		 * Updating Manipulated data based on Matched list of Nysiis end
		 */
	}
}
