 ...
 *
 */
public class MatchedComparison_Soundex {
	 ...
	 * @throws Exception
	 */
	public void matched_soundex(String savepath,
		...
		String file1 = path + "mismatched_soundex.csv";
		String file2 = path + "matched_soundex.csv";
		...
		/**
		 * Reading Matched word list of Soundex into Arraylist start
		 */
		...
		CSVFile2.close();
		/**
		 * Reading Matched word list of Soundex into Arraylist end
		 */
		...
		/**
		 * Updating Manipulated data based on Matched list of Soundex start
		 */
		...
		writer.close();
		/**
		 * Updating Manipulated data based on Matched list of Soundex end
		 */
	}
}
