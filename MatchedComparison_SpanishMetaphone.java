 ...
 *
 */
public class MatchedComparison_SpanishMetaphone {
	 ...
	 * @throws Exception
	 */
	public void matched_spanishmetaphone(String savepath,
		...
		String file1 = path + "mismatched_spanishmetaphone.csv";
		String file2 = path + "matched_spanishmetaphone.csv";
		...
		/**
		 * Updating Manipulated data based on Matched list of Spanish metaphone
		 * start
		 */
				...
				if (al1.get(k).matches(part1)) {
					if (part2.matches(al3.get(k))
						...
						for (WordSuggestions ws : WordSuggestions) {
							if (ws.type.matches("SpanishMetaphone")
