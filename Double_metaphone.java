...
public class Double_metaphone implements StrEncoder {
    ...
    public Object encode(final Object obj) throws EncodeException {
        if (!(obj instanceof String)) {
            throw new EncodeException("DoubleMetaphone encode parameter is not of type String");
        }
    ...
    public class DoubleMetaphoneResult {
        ...
        /**
         * @return primary Double Metaphone code.
         */
        ...
        /**
         * @return alternate Double metaphone code.
         */
        ...
        /**
         * @return true if string is complete
         */
