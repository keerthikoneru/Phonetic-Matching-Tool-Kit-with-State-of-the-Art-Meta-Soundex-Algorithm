 ...
 *
 */
public class MatchedComparison_SpanishSoundex {
	 ...
	 * @throws Exception
	 */
	public void matched_spanishsoundex(String savepath,
			List<WordSuggestions> WordSuggestions)
			throws FileNotFoundException, IOException, Exception {
		/**
		 * Comparison of Soundex word list with Original list
		 */
		String path = savepath;
		String file1 = path + "mismatched_spanishsoundex.csv";
		String file2 = path + "matched_spanishsoundex.csv";
		...
		/**
		 * Reading Matched word list of SpanishSoundex into Arraylist start
		 */
		...
		CSVFile2.close();
		/**
		 * Reading Matched word list of SpanishSoundex into Arraylist end
		 */
		...
		/**
		 * Updating Manipulated data based on Matched list of SpanishSoundex
		 * start
		 */
				...
				if (al1.get(k).matches(part1)) {
					if (part2.matches(al3.get(k))
						...
						for (WordSuggestions ws : WordSuggestions) {
							if (ws.type.matches("SpanishSoundex")
		...
		writer.close();
		/**
		 * Updating Manipulated data based on Matched list of SpanishSoundex end
		 */
	}
}
